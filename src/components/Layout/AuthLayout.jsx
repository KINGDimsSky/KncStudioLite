...
const AuthLayout = ({title}) => {
  ...
  return (
    <div className="flex flex-col  w-[26rem] bg-white shadow-2xl shadow-gray-700 py-2 px-4">
       ...
       <form onSubmit={confirmHandler}>
        ...
        <Button Logo={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
          ...
          <h2 className='mt-2 text-xs tracking-tighter'>{title == "SignUp" ? "Already Have Account?" : "Dont have an Account?"} <span onClick={buttonHandler} className='ml-1 font-semibold text-purple-500 cursor-pointer'>{title == "SignIn" ? "Sign Up" : "Sign In"}</span></h2>
    </div>
  )
}
